...
export const useDocumentStore = defineStore("document", () => {
  ...
  function updateRepairSettings(next: RepairSettings) { repairSettings.value = { enabledRuleIds: [...new Set(next.enabledRuleIds)], minimumConfidence: next.minimumConfidence }; saveRepairSettings(repairSettings.value); }
