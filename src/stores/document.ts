...
export const useDocumentStore = defineStore("document", () => {
  ...
  function updateRepairSettings(next: RepairSettings) { repairSettings.value = { enabledRuleIds: [...new Set(next.enabledRuleIds)], sectionNumberStartLevel: next.sectionNumberStartLevel === 2 ? 2 : 1 }; saveRepairSettings(repairSettings.value); }
